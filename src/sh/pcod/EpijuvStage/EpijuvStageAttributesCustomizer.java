/*
 * EpijuvStageAttributesCustomizer.java
 *
 ...
 */
public class EpijuvStageAttributesCustomizer extends AttributesCustomizer {

    private boolean showHorizPos = true;
    private boolean showVertPos = true;
    
    private EpijuvStageAttributes attributes = null;
    
    /**
     * Creates new customizer EpijuvStageAttributesCustomizer
     */
    public EpijuvStageAttributesCustomizer() {
        initComponents();
    }
    ...
    public void setObject(Object bean) {
        if (bean instanceof EpijuvStageAttributes) {
            setAttributes((EpijuvStageAttributes) bean);
        }
    }
    ...
    public void setAttributes(LifeStageAttributesInterface newAtts) {
        if (newAtts instanceof EpijuvStageAttributes) {
            attributes = (EpijuvStageAttributes) newAtts;
