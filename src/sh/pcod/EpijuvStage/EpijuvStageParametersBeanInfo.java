 ...
 */
public class EpijuvStageParametersBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( sh.pcod.EpijuvStage.EpijuvStageParameters.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_CSV] = new PropertyDescriptor ( "CSV", sh.pcod.EpijuvStage.EpijuvStageParameters.class, "getCSV", null ); // NOI18N
            properties[PROPERTY_CSVHeader] = new PropertyDescriptor ( "CSVHeader", sh.pcod.EpijuvStage.EpijuvStageParameters.class, "getCSVHeader", null ); // NOI18N
            properties[PROPERTY_IBMFunctionCategories] = new PropertyDescriptor ( "IBMFunctionCategories", sh.pcod.EpijuvStage.EpijuvStageParameters.class, "getIBMFunctionCategories", null ); // NOI18N
            properties[PROPERTY_IBMParameterKeys] = new PropertyDescriptor ( "IBMParameterKeys", sh.pcod.EpijuvStage.EpijuvStageParameters.class, "getIBMParameterKeys", null ); // NOI18N
            properties[PROPERTY_keys] = new PropertyDescriptor ( "keys", sh.pcod.EpijuvStage.EpijuvStageParameters.class, "getKeys", null ); // NOI18N
            properties[PROPERTY_typeName] = new PropertyDescriptor ( "typeName", sh.pcod.EpijuvStage.EpijuvStageParameters.class, "getTypeName", "setTypeName" ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( sh.pcod.EpijuvStage.EpijuvStageParameters.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            methods[METHOD_clone0] = new MethodDescriptor(sh.pcod.EpijuvStage.EpijuvStageParameters.class.getMethod("clone", new Class[] {})); // NOI18N
            methods[METHOD_clone0].setDisplayName ( "" );
            methods[METHOD_createInstance1] = new MethodDescriptor(sh.pcod.EpijuvStage.EpijuvStageParameters.class.getMethod("createInstance", new Class[] {java.lang.String[].class})); // NOI18N
            ...
            methods[METHOD_setValue22] = new MethodDescriptor(sh.pcod.EpijuvStage.EpijuvStageParameters.class.getMethod("setValue", new Class[] {java.lang.String.class, java.lang.Object.class})); // NOI18N
