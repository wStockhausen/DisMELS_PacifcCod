...
public class IBMFunction_Epijuv_VerticalSwimmingSpeed extends AbstractIBMFunction {
    ...
    public IBMFunction_Epijuv_VerticalSwimmingSpeed(){
        super(numParams,numSubFuncs,DEFAULT_type,DEFAULT_name,DEFAULT_descr,DEFAULT_fullDescr);
    }
    
    @Override
    public Object clone() {
        IBMFunction_Epijuv_VerticalSwimmingSpeed clone = new IBMFunction_Epijuv_VerticalSwimmingSpeed();
