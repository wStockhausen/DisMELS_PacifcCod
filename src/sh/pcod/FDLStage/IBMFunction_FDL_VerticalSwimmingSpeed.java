...
public class IBMFunction_FDL_VerticalSwimmingSpeed extends AbstractIBMFunction {
    ...
    public IBMFunction_FDL_VerticalSwimmingSpeed(){
        super(numParams,numSubFuncs,DEFAULT_type,DEFAULT_name,DEFAULT_descr,DEFAULT_fullDescr);
    }
    
    @Override
    public Object clone() {
        IBMFunction_FDL_VerticalSwimmingSpeed clone = new IBMFunction_FDL_VerticalSwimmingSpeed();
