/*
 * FDLStageAttributesCustomizer.java
 *
 ...
 */
public class FDLStageAttributesCustomizer extends AttributesCustomizer {

    private boolean showHorizPos = true;
    private boolean showVertPos = true;
    
    private FDLStageAttributes attributes = null;
    
    /**
     * Creates new customizer FDLStageAttributesCustomizer
     */
    public FDLStageAttributesCustomizer() {
        initComponents();
    }
    ...
    public void setObject(Object bean) {
        if (bean instanceof FDLStageAttributes) {
            setAttributes((FDLStageAttributes) bean);
        }
    }
    ...
    public void setAttributes(LifeStageAttributesInterface newAtts) {
        if (newAtts instanceof FDLStageAttributes) {
            attributes = (FDLStageAttributes) newAtts;
