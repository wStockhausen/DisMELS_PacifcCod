 ...
 */
public class IBMFunction_HatchSuccessBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( sh.pcod.EggStage.IBMFunction_HatchSuccess.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_CSV] = new PropertyDescriptor ( "CSV", sh.pcod.EggStage.IBMFunction_HatchSuccess.class, "getCSV", null ); // NOI18N
            properties[PROPERTY_CSVHeader] = new PropertyDescriptor ( "CSVHeader", sh.pcod.EggStage.IBMFunction_HatchSuccess.class, "getCSVHeader", null ); // NOI18N
            properties[PROPERTY_description] = new PropertyDescriptor ( "description", sh.pcod.EggStage.IBMFunction_HatchSuccess.class, "getDescription", "setDescription" ); // NOI18N
            properties[PROPERTY_fullDescription] = new PropertyDescriptor ( "fullDescription", sh.pcod.EggStage.IBMFunction_HatchSuccess.class, "getFullDescription", "setFullDescription" ); // NOI18N
            properties[PROPERTY_functionName] = new PropertyDescriptor ( "functionName", sh.pcod.EggStage.IBMFunction_HatchSuccess.class, "getFunctionName", "setFunctionName" ); // NOI18N
            properties[PROPERTY_functionType] = new PropertyDescriptor ( "functionType", sh.pcod.EggStage.IBMFunction_HatchSuccess.class, "getFunctionType", "setFunctionType" ); // NOI18N
            properties[PROPERTY_parameterNames] = new PropertyDescriptor ( "parameterNames", sh.pcod.EggStage.IBMFunction_HatchSuccess.class, "getParameterNames", null ); // NOI18N
            properties[PROPERTY_subfunctionNames] = new PropertyDescriptor ( "subfunctionNames", sh.pcod.EggStage.IBMFunction_HatchSuccess.class, "getSubfunctionNames", null ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( sh.pcod.EggStage.IBMFunction_HatchSuccess.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            methods[METHOD_calculate0] = new MethodDescriptor(sh.pcod.EggStage.IBMFunction_HatchSuccess.class.getMethod("calculate", new Class[] {java.lang.Object.class})); // NOI18N
            methods[METHOD_calculate0].setDisplayName ( "" );
            methods[METHOD_clone1] = new MethodDescriptor(sh.pcod.EggStage.IBMFunction_HatchSuccess.class.getMethod("clone", new Class[] {})); // NOI18N
            ...
            methods[METHOD_setParameterValue9] = new MethodDescriptor(sh.pcod.EggStage.IBMFunction_HatchSuccess.class.getMethod("setParameterValue", new Class[] {java.lang.String.class, java.lang.Object.class})); // NOI18N
