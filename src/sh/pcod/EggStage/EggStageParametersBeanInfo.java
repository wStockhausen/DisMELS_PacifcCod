...
public class EggStageParametersBeanInfo extends SimpleBeanInfo {
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_CSV] = new PropertyDescriptor ( "CSV", sh.pcod.EggStage.EggStageParameters.class, "getCSV", null ); // NOI18N
            properties[PROPERTY_CSVHeader] = new PropertyDescriptor ( "CSVHeader", sh.pcod.EggStage.EggStageParameters.class, "getCSVHeader", null ); // NOI18N
            ...
            properties[PROPERTY_IBMParameterKeys] = new PropertyDescriptor ( "IBMParameterKeys", sh.pcod.EggStage.EggStageParameters.class, "getIBMParameterKeys", null ); // NOI18N
            properties[PROPERTY_keys] = new PropertyDescriptor ( "keys", sh.pcod.EggStage.EggStageParameters.class, "getKeys", null ); // NOI18N
            properties[PROPERTY_typeName] = new PropertyDescriptor ( "typeName", sh.pcod.EggStage.EggStageParameters.class, "getTypeName", "setTypeName" ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( sh.pcod.EggStage.EggStageParameters.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            methods[METHOD_clone0] = new MethodDescriptor(sh.pcod.EggStage.EggStageParameters.class.getMethod("clone", new Class[] {})); // NOI18N
            methods[METHOD_clone0].setDisplayName ( "" );
            methods[METHOD_createInstance1] = new MethodDescriptor(sh.pcod.EggStage.EggStageParameters.class.getMethod("createInstance", new Class[] {java.lang.String[].class})); // NOI18N
            ...
            methods[METHOD_setValue22] = new MethodDescriptor(sh.pcod.EggStage.EggStageParameters.class.getMethod("setValue", new Class[] {java.lang.String.class, java.lang.Object.class})); // NOI18N
