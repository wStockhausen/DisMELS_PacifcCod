...
public class FDLpfStageParameters extends AbstractLHSParameters {
    ...
    /**
     * Creates a new instance of FDLpfStageParameters.
     */
    public FDLpfStageParameters() {
     ...
     * Creates a new instance of FDLpfStageParameters
     */
    public FDLpfStageParameters(String typeName) {
   ...
   public void selectIBMFunctionForCategory(String cat, String key){
    ...
    @Override
    public Object clone() {
        FDLpfStageParameters clone = null;
        try {
            clone = (FDLpfStageParameters) super.clone();
     ...
     */
    @Override
    public FDLpfStageParameters createInstance(final String[] strv) {
        int c = 0;
        FDLpfStageParameters params = new FDLpfStageParameters(strv[c++]);
