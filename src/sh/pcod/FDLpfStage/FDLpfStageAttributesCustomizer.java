/*
 * FDLpfStageAttributesCustomizer.java
 *
 ...
 */
public class FDLpfStageAttributesCustomizer extends AttributesCustomizer {

    private boolean showHorizPos = true;
    private boolean showVertPos = true;
    
    private FDLpfStageAttributes attributes = null;
    
    /**
     * Creates new customizer FDLpfStageAttributesCustomizer
     */
    public FDLpfStageAttributesCustomizer() {
        initComponents();
    }
    ...
    public void setObject(Object bean) {
        if (bean instanceof FDLpfStageAttributes) {
            setAttributes((FDLpfStageAttributes) bean);
        }
    }
    ...
    public void setAttributes(LifeStageAttributesInterface newAtts) {
        if (newAtts instanceof FDLpfStageAttributes) {
            attributes = (FDLpfStageAttributes) newAtts;
