 ...
 * @author sarahh
 */
public class FDLpfStageAttributesBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( sh.pcod.FDLpfStage.FDLpfStageAttributes.class , FDLpfStageAttributesCustomizer.class ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_active] = new PropertyDescriptor ( "active", sh.pcod.FDLpfStage.FDLpfStageAttributes.class, "isActive", "setActive" ); // NOI18N
            properties[PROPERTY_alive] = new PropertyDescriptor ( "alive", sh.pcod.FDLpfStage.FDLpfStageAttributes.class, "isAlive", "setAlive" ); // NOI18N
            properties[PROPERTY_arrayList] = new PropertyDescriptor ( "arrayList", sh.pcod.FDLpfStage.FDLpfStageAttributes.class, "getArrayList", null ); // NOI18N
            properties[PROPERTY_attributes] = new PropertyDescriptor ( "attributes", sh.pcod.FDLpfStage.FDLpfStageAttributes.class, "getAttributes", null ); // NOI18N
            properties[PROPERTY_classes] = new PropertyDescriptor ( "classes", sh.pcod.FDLpfStage.FDLpfStageAttributes.class, "getClasses", null ); // NOI18N
            properties[PROPERTY_CSV] = new PropertyDescriptor ( "CSV", sh.pcod.FDLpfStage.FDLpfStageAttributes.class, "getCSV", null ); // NOI18N
            properties[PROPERTY_CSVHeader] = new PropertyDescriptor ( "CSVHeader", sh.pcod.FDLpfStage.FDLpfStageAttributes.class, "getCSVHeader", null ); // NOI18N
            properties[PROPERTY_CSVHeaderShortNames] = new PropertyDescriptor ( "CSVHeaderShortNames", sh.pcod.FDLpfStage.FDLpfStageAttributes.class, "getCSVHeaderShortNames", null ); // NOI18N
            properties[PROPERTY_geometry] = new PropertyDescriptor ( "geometry", sh.pcod.FDLpfStage.FDLpfStageAttributes.class, "getGeometry", "setGeometry" ); // NOI18N
            properties[PROPERTY_ID] = new PropertyDescriptor ( "ID", sh.pcod.FDLpfStage.FDLpfStageAttributes.class, "getID", null ); // NOI18N
            properties[PROPERTY_keys] = new PropertyDescriptor ( "keys", sh.pcod.FDLpfStage.FDLpfStageAttributes.class, "getKeys", null ); // NOI18N
            properties[PROPERTY_shortNames] = new PropertyDescriptor ( "shortNames", sh.pcod.FDLpfStage.FDLpfStageAttributes.class, "getShortNames", null ); // NOI18N
            properties[PROPERTY_startTime] = new PropertyDescriptor ( "startTime", sh.pcod.FDLpfStage.FDLpfStageAttributes.class, "getStartTime", "setStartTime" ); // NOI18N
            properties[PROPERTY_typeName] = new PropertyDescriptor ( "typeName", sh.pcod.FDLpfStage.FDLpfStageAttributes.class, "getTypeName", null ); // NOI18N
            properties[PROPERTY_values] = new PropertyDescriptor ( "values", sh.pcod.FDLpfStage.FDLpfStageAttributes.class, null, "setValues" ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( sh.pcod.FDLpfStage.FDLpfStageAttributes.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            methods[METHOD_clone0] = new MethodDescriptor(sh.pcod.FDLpfStage.FDLpfStageAttributes.class.getMethod("clone", new Class[] {})); // NOI18N
            methods[METHOD_clone0].setDisplayName ( "" );
            methods[METHOD_createInstance1] = new MethodDescriptor(sh.pcod.FDLpfStage.FDLpfStageAttributes.class.getMethod("createInstance", new Class[] {java.lang.String[].class})); // NOI18N
            ...
            methods[METHOD_getValueAsString12] = new MethodDescriptor(sh.pcod.FDLpfStage.FDLpfStageAttributes.class.getMethod("getValueAsString", new Class[] {java.lang.String.class})); // NOI18N
            ...
            methods[METHOD_setValueFromString18] = new MethodDescriptor(sh.pcod.FDLpfStage.FDLpfStageAttributes.class.getMethod("setValueFromString", new Class[] {java.lang.String.class, java.lang.String.class})); // NOI18N
