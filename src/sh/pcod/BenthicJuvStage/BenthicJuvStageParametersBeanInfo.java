 ...
 */
public class BenthicJuvStageParametersBeanInfo extends SimpleBeanInfo {
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            ...
            properties[PROPERTY_IBMParameterKeys] = new PropertyDescriptor ( "IBMParameterKeys", sh.pcod.BenthicJuvStage.BenthicJuvStageParameters.class, "getIBMParameterKeys", null ); // NOI18N
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            methods[METHOD_clone0] = new MethodDescriptor(sh.pcod.BenthicJuvStage.BenthicJuvStageParameters.class.getMethod("clone", new Class[] {})); // NOI18N
            methods[METHOD_clone0].setDisplayName ( "" );
            methods[METHOD_createInstance1] = new MethodDescriptor(sh.pcod.BenthicJuvStage.BenthicJuvStageParameters.class.getMethod("createInstance", new Class[] {java.lang.String[].class})); // NOI18N
