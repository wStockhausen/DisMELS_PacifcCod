...
public class IBMFunction_YSL_GrowthRateSL extends AbstractIBMFunction implements IBMGrowthFunctionInterface {
    ...
    public IBMFunction_YSL_GrowthRateSL(){
        super(numParams,numSubFuncs,DEFAULT_type,DEFAULT_name,DEFAULT_descr,DEFAULT_fullDescr);
    }
    
    @Override
    public Object clone() {
        IBMFunction_YSL_GrowthRateSL clone = new IBMFunction_YSL_GrowthRateSL();
