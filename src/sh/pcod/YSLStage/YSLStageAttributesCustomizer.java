/*
 * YSLStageAttributesCustomizer.java
 *
 ...
 */
public class YSLStageAttributesCustomizer extends AttributesCustomizer {

    private boolean showHorizPos = true;
    private boolean showVertPos = true;
    
    private YSLStageAttributes attributes = null;
    
    /**
     * Creates new customizer YSLStageAttributesCustomizer
     */
    public YSLStageAttributesCustomizer() {
        initComponents();
    }
    ...
    public void setObject(Object bean) {
        if (bean instanceof YSLStageAttributes) {
            setAttributes((YSLStageAttributes) bean);
        }
    }
    ...
    public void setAttributes(LifeStageAttributesInterface newAtts) {
        if (newAtts instanceof YSLStageAttributes) {
            attributes = (YSLStageAttributes) newAtts;
