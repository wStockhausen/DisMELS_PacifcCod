 ...
 * @author sarahh
 */
public class YSLStageAttributesBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( sh.pcod.YSLStage.YSLStageAttributes.class , sh.pcod.LarvalAttributesCustomizer.class ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_active] = new PropertyDescriptor ( "active", sh.pcod.YSLStage.YSLStageAttributes.class, "isActive", "setActive" ); // NOI18N
            properties[PROPERTY_alive] = new PropertyDescriptor ( "alive", sh.pcod.YSLStage.YSLStageAttributes.class, "isAlive", "setAlive" ); // NOI18N
            properties[PROPERTY_arrayList] = new PropertyDescriptor ( "arrayList", sh.pcod.YSLStage.YSLStageAttributes.class, "getArrayList", null ); // NOI18N
            properties[PROPERTY_attributes] = new PropertyDescriptor ( "attributes", sh.pcod.YSLStage.YSLStageAttributes.class, "getAttributes", null ); // NOI18N
            properties[PROPERTY_classes] = new PropertyDescriptor ( "classes", sh.pcod.YSLStage.YSLStageAttributes.class, "getClasses", null ); // NOI18N
            properties[PROPERTY_CSV] = new PropertyDescriptor ( "CSV", sh.pcod.YSLStage.YSLStageAttributes.class, "getCSV", null ); // NOI18N
            properties[PROPERTY_CSVHeader] = new PropertyDescriptor ( "CSVHeader", sh.pcod.YSLStage.YSLStageAttributes.class, "getCSVHeader", null ); // NOI18N
            properties[PROPERTY_CSVHeaderShortNames] = new PropertyDescriptor ( "CSVHeaderShortNames", sh.pcod.YSLStage.YSLStageAttributes.class, "getCSVHeaderShortNames", null ); // NOI18N
            properties[PROPERTY_geometry] = new PropertyDescriptor ( "geometry", sh.pcod.YSLStage.YSLStageAttributes.class, "getGeometry", "setGeometry" ); // NOI18N
            properties[PROPERTY_ID] = new PropertyDescriptor ( "ID", sh.pcod.YSLStage.YSLStageAttributes.class, "getID", null ); // NOI18N
            properties[PROPERTY_keys] = new PropertyDescriptor ( "keys", sh.pcod.YSLStage.YSLStageAttributes.class, "getKeys", null ); // NOI18N
            properties[PROPERTY_shortNames] = new PropertyDescriptor ( "shortNames", sh.pcod.YSLStage.YSLStageAttributes.class, "getShortNames", null ); // NOI18N
            properties[PROPERTY_startTime] = new PropertyDescriptor ( "startTime", sh.pcod.YSLStage.YSLStageAttributes.class, "getStartTime", "setStartTime" ); // NOI18N
            properties[PROPERTY_typeName] = new PropertyDescriptor ( "typeName", sh.pcod.YSLStage.YSLStageAttributes.class, "getTypeName", null ); // NOI18N
            properties[PROPERTY_values] = new PropertyDescriptor ( "values", sh.pcod.YSLStage.YSLStageAttributes.class, null, "setValues" ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( sh.pcod.YSLStage.YSLStageAttributes.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_createInstance1] = new MethodDescriptor(sh.pcod.YSLStage.YSLStageAttributes.class.getMethod("createInstance", new Class[] {java.lang.String[].class})); // NOI18N
