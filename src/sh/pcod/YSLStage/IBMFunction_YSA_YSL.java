...
public class IBMFunction_YSA_YSL extends AbstractIBMFunction implements IBMGrowthFunctionInterface {
    ...
    public IBMFunction_YSA_YSL(){
        super(numParams,numSubFuncs,DEFAULT_type,DEFAULT_name,DEFAULT_descr,DEFAULT_fullDescr);
    }
    
    @Override
    public Object clone() {
        IBMFunction_YSA_YSL clone = new IBMFunction_YSA_YSL();
